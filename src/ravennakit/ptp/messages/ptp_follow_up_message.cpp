...
rav::ptp_follow_up_message::from_data(const buffer_view<const uint8_t> data) {
...
void rav::ptp_follow_up_message::write_to(output_stream& stream) const {
    precise_origin_timestamp.write_to(stream);
}
