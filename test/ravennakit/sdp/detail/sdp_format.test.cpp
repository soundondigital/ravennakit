...
TEST_CASE("media_description | format") {
    ...
    SECTION("98/L16/48000/4") {
        auto fmt = rav::sdp::Format::parse_new("98 L16/48000/4");
        REQUIRE(fmt);
        REQUIRE(fmt->payload_type == 98);
        REQUIRE(fmt->encoding_name == "L16");
        REQUIRE(fmt->clock_rate == 48000);
    ...
    SECTION("98/L24/48000/2") {
        auto fmt = rav::sdp::Format::parse_new("98 L24/48000/2");
        REQUIRE(fmt);
        REQUIRE(fmt->payload_type == 98);
    ...
    SECTION("98/L32/48000/2") {
        auto fmt = rav::sdp::Format::parse_new("98 L32/48000/2");
        REQUIRE(fmt);
        REQUIRE(fmt->payload_type == 98);
    ...
    SECTION("98/NA/48000/2") {
        auto fmt = rav::sdp::Format::parse_new("98 NA/48000/2");
        REQUIRE(fmt);
        REQUIRE(fmt->payload_type == 98);
