...
TEST_CASE("reference_clock", "[reference_clock]") {
    SECTION("Test IEEE1588-2008 with domain") {
        ...
        auto result = rav::sdp::ReferenceClock::parse_new(str);
        REQUIRE(result.is_ok());
        auto ref_clock = result.move_ok();
        REQUIRE(ref_clock.source() == rav::sdp::ReferenceClock::ClockSource::ptp);
        REQUIRE(ref_clock.ptp_version() == rav::sdp::ReferenceClock::PtpVersion::IEEE_1588_2008);
    ...
    SECTION("Test IEEE1588-2002:traceable") {
        ...
        auto ref_clock = result.move_ok();
        REQUIRE(ref_clock.source() == rav::sdp::ReferenceClock::ClockSource::ptp);
        REQUIRE(ref_clock.ptp_version() == rav::sdp::ReferenceClock::PtpVersion::IEEE_1588_2002);
    ...
    SECTION("Test IEEE802.1AS-2011") {
        ...
        auto ref_clock = result.move_ok();
        REQUIRE(ref_clock.source() == rav::sdp::ReferenceClock::ClockSource::ptp);
        REQUIRE(ref_clock.ptp_version() == rav::sdp::ReferenceClock::PtpVersion::IEEE_802_1AS_2011);
        REQUIRE(ref_clock.gmid() == "39-A7-94-FF-FE-07-CB-D0");
        REQUIRE_FALSE(ref_clock.domain().has_value());
    }
    ...
    SECTION("Test traceable") {
        ...
        auto ref_clock = result.move_ok();
        REQUIRE(ref_clock.source() == rav::sdp::ReferenceClock::ClockSource::ptp);
        REQUIRE(ref_clock.ptp_version() == rav::sdp::ReferenceClock::PtpVersion::traceable);
