...
TEST_CASE("rav string utils") {
    SECTION("string | up_to_first_occurrence_of") {
    ...
    SECTION("string | up_to_the_nth_occurrence_of") {
    ...
    SECTION("string | up_to_last_occurrence_of") {
        constexpr std::string_view haystack("one test two test three test");
    ...
    SECTION("string | from_first_occurrence_of") {
        constexpr std::string_view haystack("one test two test three test");
    ...
    SECTION("string | from_nth_occurrence_of") {
        std::string_view haystack("/one/two/three/four");
    ...
    SECTION("string | from_last_occurrence_of") {
        constexpr std::string_view haystack("one test two test three test");
    ...
    SECTION("string | string_contains") {
        SECTION("Without substring included") {
    ...
    SECTION("string | from_string_strict") {
    ...
    SECTION("string | string_compare_case_insensitive") {
    ...
    SECTION("string | string_to_upper") {
        SECTION("Lower") {
    ...
    SECTION("string | string_to_lower") {
        SECTION("Upper") {
            const std::string str("ABC");
