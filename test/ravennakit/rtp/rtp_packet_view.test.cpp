...
TEST_CASE("rav::rtp::RtpPacketView") {
    SECTION("rtp_packet_view::rtp_packet_view()", "[rtp_packet_view]") {
        uint8_t data[] = {
    ...
    SECTION("rtp_packet_view::validate()", "[rtp_packet_view]") {
    ...
    SECTION("rtp_packet_view::ssrc()", "[rtp_packet_view]") {
        const uint8_t data[] = {
            // v, p, x, cc
            0b10000010,
            // m, pt
    ...
    SECTION("rtp_packet_view::get_header_extension_data()", "[rtp_packet_view]") {
    ...
    SECTION("rtp_packet_view::header_total_length()", "[rtp_packet_view]") {
    ...
    SECTION("rtp_packet_view::payload_data()", "[rtp_packet_view]") {
