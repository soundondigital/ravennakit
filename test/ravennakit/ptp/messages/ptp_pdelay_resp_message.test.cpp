...
TEST_CASE("ptp_pdelay_resp_message") {
    SECTION("Unpack") {
        ...
        auto msg = rav::ptp_pdelay_resp_message::from_data(rav::buffer_view(data)).value();
        REQUIRE(msg.request_receipt_timestamp.seconds == 0x123456789012);
        REQUIRE(msg.request_receipt_timestamp.nanoseconds == 0x34567890);
    ...
    SECTION("Pack") {
        rav::ptp_pdelay_resp_message msg;
        msg.request_receipt_timestamp.seconds = 0x123456789012;
        msg.request_receipt_timestamp.nanoseconds = 0x34567890;
