...
TEST_CASE("ptp_clock_identity") {
    SECTION("Construct from MAC address") {
        ...
        const rav::ptp_clock_identity clock_identity = rav::ptp_clock_identity::from_mac_address(mac_address);
    ...
    SECTION("Default constructor") {
        constexpr rav::ptp_clock_identity clock_identity;
        REQUIRE(clock_identity.empty());
    }

    SECTION("Empty") {
        rav::ptp_clock_identity clock_identity;
        REQUIRE(clock_identity.empty());
