...
TEST_CASE("rav::ptp::Timestamp") {
    ...
    SECTION("Construct from max nanos value") {
        rav::ptp::Timestamp ts(std::numeric_limits<uint64_t>::max());
        REQUIRE(ts.raw_seconds() == 18446744073);
        REQUIRE(ts.raw_nanoseconds() == 709551615);
    }

    SECTION("Add") {
        rav::ptp::Timestamp ts1(1'000'000'001);
        rav::ptp::Timestamp ts2(1'000'000'002);
        auto result = ts1 + ts2;
    ...
    SECTION("Add overflow") {
        rav::ptp::Timestamp ts1(1'500'000'000);
        rav::ptp::Timestamp ts2(1'500'000'001);
        auto result = ts1 + ts2;
    ...
    SECTION("Subtract") {
        rav::ptp::Timestamp ts1(2'000'000'002);
        rav::ptp::Timestamp ts2(1'000'000'001);
        auto result = ts1 - ts2;
    ...
    SECTION("Subtract underflow") {
        rav::ptp::Timestamp ts1(2'500'000'001);
        rav::ptp::Timestamp ts2(1'500'000'002);
        auto result = ts1 - ts2;
    ...
    SECTION("Greater than") {
        rav::ptp::Timestamp ts1(1'000'000'002);
        rav::ptp::Timestamp ts2(1'000'000'001);
        REQUIRE(ts1 > ts2);
        REQUIRE_FALSE(ts2 > ts1);
    }
    ...
    SECTION("Add time interval") {
        ...
        SECTION("Add -2.5ns") {
            rav::ptp::Timestamp ts(1'000'000'001);
            rav::ptp::TimeInterval ti(0, -3, 0x8000);
        ...
        SECTION("Add -2ns") {
            rav::ptp::Timestamp ts(1'000'000'001);
            rav::ptp::TimeInterval ti(0, -2, 0x0000);
            ts.add(ti);
            REQUIRE(ts.raw_seconds() == 0);
        ...
        SECTION("Add -2.49s") {
            rav::ptp::Timestamp ts(3'000'000'000);
    ...
    SECTION("To time interval") {
        rav::ptp::Timestamp ts(3'000'000'001);
