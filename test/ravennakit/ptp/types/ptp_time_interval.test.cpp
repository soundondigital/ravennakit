...
TEST_CASE("rav::ptp::TimeInterval") {
    ...
    SECTION("Constructor initializes with correct values") {
        SECTION("Positive values") {
            rav::ptp::TimeInterval interval(5, 5'000'000, 0x3fff);  // 5.50000005s
        ...
        SECTION("Negative values") {
            rav::ptp::TimeInterval negative_interval(-5, 5'000'000, 0x3fff);
        ...
        SECTION("Normalize nanos") {
            rav::ptp::TimeInterval normalize(5, 2'000'000'000, 0x3fff);
        ...
        SECTION("Normalize nanos 2") {
            rav::ptp::TimeInterval normalize(5, 2'100'000'000, 0x3fff);
            REQUIRE(normalize.seconds() == 7);
        ...
        SECTION("Normalize nanos 3") {
            rav::ptp::TimeInterval normalize(5, -1'000'000'000, 0);
        ...
        SECTION("Normalize nanos 4") {
            rav::ptp::TimeInterval normalize(5, -1'000'000'000, 0x3fff);
            REQUIRE(normalize.seconds() == 4);
            REQUIRE(normalize.nanos() == 0);
            REQUIRE(normalize.fraction() == 0x3fff);
        }
        ...
        SECTION("Normalize nanos 5") {
            rav::ptp::TimeInterval normalize(5, -1'100'000'000, 0x3fff);
        ...
        SECTION("Normalize nanos 6") {
            rav::ptp::TimeInterval normalize(5, -900'000'000, 0x3fff);
            REQUIRE(normalize.seconds() == 4);
            REQUIRE(normalize.nanos() == 100'000'000);
            REQUIRE(normalize.fraction() == 0x3fff);
        }
    ...
    SECTION("Arithmetic addition works correctly") {
        SECTION("Check arithmetic") {
            rav::ptp::TimeInterval interval1(3, 50000, 0x2000);
            rav::ptp::TimeInterval interval2(4, 70000, 0x1000);

            rav::ptp::TimeInterval result = interval1 + interval2;
        ...
        SECTION("Check normalization of nanos during addition") {
            rav::ptp::TimeInterval interval3(3, 500'000'000, 0x2000);
            rav::ptp::TimeInterval interval4(1, 500'000'000, 0x1000);

            rav::ptp::TimeInterval result2 = interval3 + interval4;
        ...
        SECTION("Check normalization of fractal during addition") {
            ...
            rav::ptp::TimeInterval interval1(3, 0, 0xffff);
            rav::ptp::TimeInterval interval2(1, 0, 1);
    ...
    SECTION("Arithmetic subtraction works correctly") {
        ...
        SECTION("Check normalization of nanos during subtraction") {
            rav::ptp::TimeInterval interval3(3, 500'000'000, 0x2000);
            rav::ptp::TimeInterval interval4(1, 600'000'000, 0x1000);
        ...
        SECTION("Check normalization of fraction during subtraction") {
            rav::ptp::TimeInterval interval1(0, 0, 0);
            rav::ptp::TimeInterval interval2(0, 0, 1);
    ...
    SECTION("From wire positive") {
        const auto interval = rav::ptp::TimeInterval::from_wire_format(0x24000);
        REQUIRE(interval.seconds() == 0);
    ...
    SECTION("To wire positive") {
        const auto interval = rav::ptp::TimeInterval(0, 2, 0x4000);
        REQUIRE(interval.to_wire_format() == 0x24000);

        // Clamp overflow to max value
        REQUIRE(
            rav::ptp::TimeInterval(std::numeric_limits<int64_t>::max(), 0, 0).to_wire_format()
            == std::numeric_limits<int64_t>::max()
        );
    }

    SECTION("To wire negative") {
        const auto interval = rav::ptp::TimeInterval(0, -3, 0xc000);
        REQUIRE(interval.to_wire_format() == -0x24000);

        // Clamp underflow to min value
        REQUIRE(
            rav::ptp::TimeInterval(std::numeric_limits<int64_t>::min(), 0, 0).to_wire_format()
            == std::numeric_limits<int64_t>::min()
        );
    }

    SECTION("From and to wire roundtrip") {
        const auto interval = rav::ptp::TimeInterval::from_wire_format(0x28000);
    ...
    SECTION("Equality and inequality operators") {
        rav::ptp::TimeInterval interval1(5, 10000, 1);
        rav::ptp::TimeInterval interval2(5, 10000, 1);
        rav::ptp::TimeInterval interval3(6, 20000, 2);
    ...
    SECTION("Chained arithmetic operations") {
        rav::ptp::TimeInterval interval1(1, 1, 1);
        rav::ptp::TimeInterval interval2(2, 2, 2);
        rav::ptp::TimeInterval interval3(3, 3, 3);

        rav::ptp::TimeInterval result = interval1 + interval2 - interval3;
    ...
    SECTION("Self-assignment operators") {
        rav::ptp::TimeInterval interval1(1, 10000, 1);
        rav::ptp::TimeInterval interval2(2, 20000, 2);
    ...
    SECTION("Nanos rounded") {
        rav::ptp::TimeInterval interval1(0, 1, 0x8000);
        REQUIRE(interval1.nanos_rounded() == 2);

        rav::ptp::TimeInterval interval2(0, 1, 0x7fff);
        REQUIRE(interval2.nanos_rounded() == 1);
    }

    SECTION("Divide 1") {
        rav::ptp::TimeInterval interval1(5, 10000, 2);
    ...
    SECTION("Divide 2") {
        auto r = rav::ptp::TimeInterval(5, 10000, 2) / 2;
        REQUIRE(r.seconds() == 2);
    ...
    SECTION("Multiply") {
        rav::ptp::TimeInterval interval1(5, 600'000'000, 2);
        interval1 *= 2;
    ...
    SECTION("Multiply") {
        rav::ptp::TimeInterval interval1(5, 600'000'000, 1);
        auto nanos = interval1.total_nanos();
        interval1 *= -1;
    ...
    SECTION("Multiply 2") {
        auto interval = rav::ptp::TimeInterval(5, 10000, 2) * 2;
    ...
    SECTION("Multiply 2") {
        auto interval = rav::ptp::TimeInterval(5, 600'000'000, 2) * 2;
    ...
    SECTION("Multiply 2") {
        auto interval = rav::ptp::TimeInterval(5, 600'000'000, 1) * -1;
    ...
    SECTION("Multiply 2") {
        auto interval = rav::ptp::TimeInterval(5, 600'000'000, 1) * -2;
